...
//     }
//     return  <div className="px-16 md-mx:px-8 mx-20  lg-mx:mx-10  md-mx:mx-0 my-10 font-mono" id="contact">
//     <h1 className="text-4xl  mb-10 font-bold  text-center " style={{ color: 'white' }}> <span
//      className="text-primaryColor">05. &nbsp;</span>Contact</h1>
//      <div data-aos="flip-left" className=" w-[70%] shadow-[0_0_10px_0_#64FFDA]  m-auto flex flex-col  gap-6 border border-primaryColor  p-8 rounded-3xl text-3xl " >
//         <div className="text-3xl   font-semibold sm-mx:text-2xl xs-mx:text-xl" style={{ color: 'white' }}>
//             Let's Connect <IconTopologyStar3 className="w-10 text-primaryColor h-10 sm-mx:w-7 sm-mx:h-7" /></div>
//         </div>
