...
//         <div className="text-textColor  rounded-2xl  items-center  text-xl font-medium">{skill}
...
//     return(
//         <div data-aos="fade-up" data-aos-duration="800" data-aos-easing="ease-in-shine" className="w-[49%] shadow-[0_0_10px_0_#64FFDA50] rounded-2xl border border-primaryColor p-5">
//             <div className="text-3xl  mb-5 text-center font-bold"style={{ color: 'white' }}>{props.title}
